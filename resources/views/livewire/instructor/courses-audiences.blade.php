<section>
    <h1 class="text-2xl font-bold"><i class="fas fa-users mr-2"></i>Course Audience</h1>
    <hr class="mt-2 mb-6">
            ...
            <div class="card-body bg-gray-100">
                ...
                @if ($audience->id == $item->id)
                    <form wire:submit.prevent="update">
                        <input wire:model="audience.name"
                            class="form-input w-full {{ $errors->has('audience.name') ? ' border-red-600' : '' }}"
                            type="text" placeholder="Enter the audience of the course">
                        @error('audience.name')
        ...
        <div class="card-body bg-gray-100">
            <form wire:submit.prevent="store">
                ...
                <div class="flex justify-end mt-2">
                    <button type="submit" class="btn btn-primary">Add Audience</button>
                </div>
            </form>
        </div>
    </article>
