<section>
    <h1 class="text-2xl font-bold"><i class="far fa-check-square mr-2"></i>Course requirements</h1>
    <hr class="mt-2 mb-6">
                ...
                @if ($requirement->id == $item->id)
                    <form wire:submit.prevent="update">
                        <input wire:model="requirement.name"
                            ...
                            type="text" placeholder="Enter a requirement">
        ...
        <div class="card-body bg-gray-100">
            <form wire:submit.prevent="store">
                <input wire:model="name" type="text"
                    ...
                    placeholder="Add the name of the requirement">
                @error('name')
                    <span class="invalid-feedback">
                        <strong class="text-xs text-red-700">{{ $message }}</strong>
                    </span>
