        ...
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div>
                ...
                <p class="text-white sm:text-md md:text-lg lg:mx-0 mb-2"><span class="text-gray-400"><i
                            class="fas fa-tags text-sm mr-2"></i>Category:&nbsp;</span>{{ $course->category->name }}
                </p>
                <p class="text-white sm:text-md md:text-lg lg:mx-0 mb-2"><span class="text-gray-400"><i
                            class="fas fa-layer-group text-sm mr-2"></i>Level:&nbsp;</span>{{ $course->level->name }}
                </p>
                ...
                <div class="flex mb-4">
                    ...
                    <p class="text-white sm:text-md md:text-lg lg:mx-0">
                        <i class="fas fa-users text-sm mr-2"></i>{{ $course->students_count }} Users
                    </p>
                </div>
            </div>
        ...
        @if (session('info'))
            <div class="lg:col-span-3" x-data="{ open: true }" x-show="open">
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                    <strong class="font-bold">Approval failed!</strong>
            ...
            <section class="card mb-12">
                <div class="card-body">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <a class="text-blue-400 text-sm font-bold"
                                href="">{{ '@' . Str::slug($course->editor->name . $course->editor->lastname, '') }}</a>
                        </div>
                    </div>
                    ...
                    @else
                        ...
                        <a href="#"
                            class="btn-cta btn-accent btn-block hover:shadow">{{ __('Buy this course') }}</a>
                    @endif
