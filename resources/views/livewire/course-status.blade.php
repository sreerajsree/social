<div class="py-12">
    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8 py-12">
        ...
        <div class="col-span-1 lg:col-span-2">
            ...
            <div class="flex mb-8">
                <button type="button"
                    class="mr-2 bg-gray-300 text-gray text-sm py-2 px-4 leading-none flex items-center focus:outline-none">
            ...
            <a href="{{ $current->url }}" title="{{ $current->name }}" target="_blank">
                <div class="mb-8 flex justify-center">
                    <button type="button"
                        class="btn btn-cta btn-primary hover:bg-blue-700 text-md py-2 px-4 leading-none flex items-center focus:outline-none">
                ...
                <div class="card-body flex">
                    ...
                    @if ($this->next)
                        <a wire:click="changeLesson({{ $this->next }})"
                            class="ml-auto cursor-pointer text-gray-400 hover:text-gray-700">Next Lesson<i
